            ...
            CellFactory.prototype.updateCell = function (panel, r, c, cell, rng, updateContent) {
                ...
                if (updateContent != false) {
                    ...
                    if (ct == 1 /* Cell */ && c == g.columns.firstVisibleIndex && gr && gr.hasChildren && !this._isEditingCell(g, r, c)) {
                        ...
                        if (wijmo.isNumber(val) && !col.dataMap) {
                            content = wijmo.Globalize.format(val, 'g12');
                        }
            ...
            */
            ...
            _MouseHandler.prototype._mouseDown = function (e) {
                ...
                if (e.target != document.activeElement && !g.containsFocus()) {
                    if (ht.cellType == 1 /* Cell */ && e.target instanceof HTMLElement) {
                        e.target.focus();
                    } else {
                        g.focus();
                    }
            ...
            function _EditHandler(grid) {
                ...
                grid.addEventListener(grid.hostElement, 'mousedown', function (e) {
                    ...
                    if (ht.cellType != 1 /* Cell */ && ht.cellType != 0 /* None */) {
                        ...
                        var edt = wijmo.tryCast(e.target, HTMLInputElement), parent = edt ? edt.parentElement : null;
                        if (edt && edt.type == 'checkbox' && parent && wijmo.hasClass(parent, 'wj-cell') && parent.parentElement == grid.cells.hostElement) {
