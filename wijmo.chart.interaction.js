                ...
                */
                ...
                RangeSelector.prototype._switchEvent = function (isOn) {
                    ...
                    if (this._rangeSelectorEle) {
                        ...
                        document[eventListener]('mousemove', this._wrapperMouseMove);
                        ...
                        if ('ontouchstart' in window) {
                            ...
                            document[eventListener]('touchmove', this._wrapperMouseMove);
                            document[eventListener]('touchend', this._wrapperMouseup);
                        }
                    }
                ...
                RangeSelector.prototype._onMousedown = function (e) {
                    ...
                    wijmo.removeClass(this._leftEle, RangeSelector._CSS_HANDLE_ACTIVE);
                    wijmo.removeClass(this._rightEle, RangeSelector._CSS_HANDLE_ACTIVE);
                    if (this._movingEle != this._middleEle) {
                        ...
                        wijmo.addClass(this._movingEle, RangeSelector._CSS_HANDLE_ACTIVE);
                    } else {
                ...
                RangeSelector._CSS_HANDLE_ACTIVE = 'wj-rangeselector-handle-active';
