        ...
        var Axis = (function () {
            ...
            */
            ...
            Axis.prototype._createTimeLabels = function (start, len, vals, lbls) {
                ...
                var dtmin0 = _chart.FlexChart._fromOADate(this._actualMin);
                var dtmax0 = _chart.FlexChart._fromOADate(this._actualMax);
                ...
                var dtmin = _chart.FlexChart._fromOADate(min);
                var dtmax = _chart.FlexChart._fromOADate(max);
                ...
                if (delta.TotalDays >= 365 && isNaN(this._majorUnit)) {
                    ...
                    for (var current = dtmin; current <= dtmax0; current.setFullYear(current.getFullYear() + years)) {
                        var val = _chart.FlexChart._toOADate(current);
                        vals.push(val);
                        lbls.push(this._formatValue(val));
                    }
            ...
            Axis.prototype._formatValue = function (val) {
                if (this._isTimeAxis) {
                    return wijmo.Globalize.format(_chart.FlexChart._fromOADate(val), this._format);
                } else {
                    if (this._format)
        ...
        */
        ...
        var _timeHelper = (function () {
            ...
            _timeHelper.prototype.getTimeAsDouble = function () {
                return _chart.FlexChart._toOADate(this.getTimeAsDateTime());
            };
...
(function (wijmo) {
    (function (chart) {
        ...
        var _FinancePlotter = (function (_super) {
                    ...
                    if (item) {
                        ...
                        if (chart._DataInfo.isValid(x) && xmin <= x && x <= xmax) {
                            ...
                            if (this.chart.itemFormatter) {
                                ...
                                this.chart.itemFormatter(engine, hti, function () {
                                    _this._drawSymbol(engine, ax, ay, si, i, symSize, x, hi, lo, open, close);
                                });
                            } else {
                                this._drawSymbol(engine, ax, ay, si, i, symSize, x, hi, lo, open, close);
                            }
                            engine.endGroup();
            ...
            _FinancePlotter.prototype._drawSymbol = function (engine, ax, ay, si, pi, w, x, hi, lo, open, close) {
