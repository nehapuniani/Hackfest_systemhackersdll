            ...
            ControlMetaFactory.getMetaData = function (metaDataId) {
                switch (metaDataId) {
                    ...
                    case wijmo.grid && wijmo.grid.detail && wijmo.grid.detail.FlexGridDetailProvider:
                        return new MetaDataBase([
                            this.CreateProp('maxHeight', 1 /* Number */),
                            this.CreateProp('detailVisibilityMode', 4 /* Enum */, 0 /* OneWay */, wijmo.grid.detail.DetailVisibilityMode),
                            this.CreateProp('rowHasDetail', 5 /* Function */)
                        ], [], [], undefined, undefined, undefined, '');
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        * that refer to the data item, its index, and owner control.
        *
        * Note that directive and parameter names must be formatted as lower-case with dashes
        * instead of camel-case. For example:
        *
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        *
        * The <b>wj-flex-grid-detail</b> directive represents a @see:FlexGridDetailProvider object
        * maintaining detail rows visibility, with detail rows content defined as an arbitrary
        * HTML fragment within the directive tag. The fragment may contain AngularJS bindings and directives.
        * In addition to any properties available in a controller, the local <b>$row</b> and
        * <b>$item</b> template variables can be used in AngularJS bindings that refer to the detail
        * row's parent @see:Row and <b>Row.dataItem</b> objects. For example:
        *
        ...
        * <b>wj-flex-grid-detail</b> directive can be retrieved in a usual way by binding to the
        * directive's <b>control</b> property. This makes all the API provided by
        ...
        * their <b>ng-click</b> bindings to implement custom show/hide logic:
        *
